...
const ResumenProducto = ({ producto }) => {
  ...
  return (
    <motion.div className="shadow p-5 mb-3 flex gap-10 items-center" initial={} whileInView={{ opacity: 1 }}>
      ...
      <div>
        ...
        <button
          type="button"
          className="bg-red-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md text-center w-full mt-3"
